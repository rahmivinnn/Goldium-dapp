...
export const PortfolioAnalytics: FC = () => {
  ...
  const updateAnalytics = useCallback(async () => {
    ...
    try {
      ...
      analyticsService.recordPortfolioSnapshot(balanceMap);
      
      // Calculate performance metrics
      const performance = analyticsService.calculatePerformanceMetrics(balanceMap);
      setPerformanceMetrics(performance);
      
      // Analyze asset allocation
      const allocation = analyticsService.analyzeAssetAllocation(balanceMap);
      setAssetAllocation(allocation);
      
      // Assess risk
      const risk = analyticsService.assessRisk(balanceMap);
      setRiskMetrics(risk);
      
      // Generate trading signals
      const signals = analyticsService.generateTradingSignals(balanceMap);
  ...
  const updatePortfolioChart = async () => {
    ...
    const currentPortfolio = priceService.calculatePortfolio(balanceMap);
