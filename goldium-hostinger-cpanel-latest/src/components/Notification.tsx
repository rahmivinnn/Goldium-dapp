...
import { SOLSCAN_CONFIG, NETWORKS } from '../config/tokens';
...
const Notification = ({ type, message, description, txid, onHide }) => {
  ...
  const getSolscanUrl = (txid: string) => {
    const networkConfig = SOLSCAN_CONFIG.getNetworkConfig(networkConfiguration as keyof typeof NETWORKS);
    return networkConfig.transactionUrl(txid);
  };
